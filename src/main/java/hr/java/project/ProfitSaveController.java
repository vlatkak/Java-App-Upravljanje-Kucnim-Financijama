...
public class ProfitSaveController implements Controller{

    private static final Logger logger = LoggerFactory.getLogger(ProfitSaveController.class);
    ...
    public void saveProfit(){
        try{
            ...
            ActualCashflowObject profit = new ActualCashflowObject.ActualCashflowObjectBuilder()
            ...
            if (confirmation.get() == ButtonType.OK) {
                DatabaseUtils.saveActualCashflowObjectToDatabase(profit);

                FileUtils.actualCashflowObjects.add(profit);
    ...
    public void back(){
        ...
        try{
            ...
            LoginStartApplication.getMainStage().setTitle("Moje financije - dobrodošli");
