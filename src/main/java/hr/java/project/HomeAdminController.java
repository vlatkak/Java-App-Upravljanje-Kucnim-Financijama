...
public class HomeAdminController {
    ...
    public void openExpectedProfitOverviewScreen(){
    ...
    public void openBudgetOverviewScreen(){
    ...
    public void openAppEntityChangesOverview(){
        FXMLLoader fxmlLoader = new FXMLLoader(LoginStartApplication.class.getResource("entityChangesOverview.fxml"));
        try{
            Scene scene = new Scene(fxmlLoader.load(), 800, 600);
            LoginStartApplication.getMainStage().setTitle("Moje financije - pregled objekata u aplikaciji");
            LoginStartApplication.getMainStage().setScene(scene);
            LoginStartApplication.getMainStage().show();
        }catch(IOException e){
            logger.error("Došlo je do pogreške prilikom otvaranja prozora");
